...
class DiscountTest {
    ...
    void init() {
        ...
        orderedMenus.addRequestOrder(new RequestOrder("아이스크림", 2));
        orderedMenus.addRequestOrder(new RequestOrder("티본스테이크", 4));
    }
    ...
    void discountTest_Christmas() {
        ...
        discount.calculateDiscountAmount(orderedMenus, normalDate);
    ...
    void discountTest_Special() {
        ...
        discount.calculateDiscountAmount(orderedMenus, specialDate);
    ...
    void discountTest_Weekend() {
        ...
        discount.calculateDiscountAmount(orderedMenus, weekendDate);
